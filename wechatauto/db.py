...
class WeChatDB:
    ...
    def get_nickname_index(self) -> Dict[str, str]:
        """Загрузить все никнеймы одним запросом (словарь username -> display_name).
        Гораздо быстрее, чем N отдельных вызовов get_nickname()."""
        return self._nickname_index()
